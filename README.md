...
3. Backport new API.
4. *Backport applicable compat recipes or small feature tweaks. Oops, it's user-facing after all.
...
**A:** No. If it's not something that you'd see in a patch version, you won't see it in Create Repair.

**Q: Does this update at the same schedule as Create?**  
**A:** No. If we fix something (in our own code or Create's) it'll be released relatively soon thereafter.

### Licensing
Most of this project is released under the [MIT license](LICENSE).  
