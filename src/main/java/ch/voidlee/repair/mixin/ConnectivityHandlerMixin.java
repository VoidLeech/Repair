...
public class ConnectivityHandlerMixin {
    @WrapOperation(method = "tryToFormNewMultiOfWidth", at = @At(value = "INVOKE", target = "Lcom/simibubi/create/foundation/blockEntity/IMultiBlockEntityContainer;notifyMultiUpdated()V", ordinal = 1))
